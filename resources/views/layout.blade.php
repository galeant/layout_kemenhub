...
<body>
                                                            ...
                                                            <div class="card-block">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <h6 class="text-muted f-w-400"><a href="https://colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="4f252a21360f28222e2623612c2022">[email&#160;protected]</a></h6>
                                                                    </div>
                                                                    <div class="col-sm-6">
    ...
    <!-- Chart js -->
    <script type="ca3f4a4549af47c295e14c01-text/javascript" src="{{ asset('bower_components/chart.js/js/Chart.js') }}"></script>
    <!-- amchart js -->
    <script src="{{ asset('pages/widget/amchart/amcharts.js') }}" type="ca3f4a4549af47c295e14c01-text/javascript"></script>
    <script src="{{ asset('pages/widget/amchart/serial.js') }}" type="ca3f4a4549af47c295e14c01-text/javascript"></script>
    <script src="{{ asset('pages/widget/amchart/light.js') }}" type="ca3f4a4549af47c295e14c01-text/javascript"></script>
    ...
    <script type="ca3f4a4549af47c295e14c01-text/javascript" src="{{ asset('pages/dashboard/custom-dashboard.js') }}"></script>
    <script type="ca3f4a4549af47c295e14c01-text/javascript" src="{{ asset('js/script.min.js') }}"></script>
<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-23581568-13" type="ca3f4a4549af47c295e14c01-text/javascript"></script>
<script type="ca3f4a4549af47c295e14c01-text/javascript">
...
<script src="{{ asset('js/rocket-loader.min.js') }}" data-cf-settings="ca3f4a4549af47c295e14c01-|49" defer=""></script></body>


<!-- Mirrored from colorlib.com/polygon/adminty/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Jun 2019 04:56:47 GMT -->
</html>
